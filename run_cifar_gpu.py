...
data_path = '/public/dataset/cifar-10/cifar-10.mat'
save_path = '/lqh/DeepUnsupervisedHashing/DSAH/data/output/cifar-10/' + version
logfile_dir = '/lqh/DeepUnsupervisedHashing/DSAH/data/log/cifar-10/'
...
W = scio.loadmat('/lqh/DeepUnsupervisedHashing/W/cifar-10/' + W + '.mat')['S']
